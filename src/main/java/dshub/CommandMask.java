...
public class CommandMask implements Serializable
{
    /*
	                ...
	                mass -- Broadcast message, can take extended params
                        ...
                        quit -- Shuts down hub.
*/
    public boolean adc,adcs,port,reg,ureg,listreg,mass,kick,drop,unban,banip,bancid,bannick,history,cmdhistory,info,hideme,password,mynick,rename,usercount,topic,
    ...
    public CommandMask ()  
    {
        adc=adcs=port=reg=ureg=listreg=mass=kick=drop=unban=banip=bancid=bannick=cmdhistory=info=hideme=rename=usercount=topic=
    ...
    public CommandMask ( int i)
    {
        if(i==1)
        {
            adc=adcs=port=reg=ureg=listreg=mass=kick=drop=unban=banip=bancid=bannick=history=cmdhistory=info=hideme=password=rename=usercount=topic=
