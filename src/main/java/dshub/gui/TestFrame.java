...
public class TestFrame extends javax.swing.JFrame {
	...
	public TestFrame() {
		...
		listaBanate = DSHubInitializer.listaBanate;
				...
				for (ClientNod temp : SimpleHandler.getUsers()) {
					if (temp.cur_client.userok == 1)
						if ((temp.cur_client.ID.equals(CID))) {
							...
							DSHubInitializer.PopMsg("User " + temp.cur_client.NI
									+ " with CID " + CID + " found, deleted.");
							DSHubInitializer.Server.rewriteregs();
							SetStatus("Reg Deleted");
							return;
						}
				}

				DSHubInitializer.PopMsg("Reg " + CID + " deleted.");
				DSHubInitializer.Server.rewriteregs();
	...
	public void refreshPyScripts() {
		...
		long up = System.currentTimeMillis() - DSHubInitializer.curtime; //uptime in millis

		Date b = new Date(DSHubInitializer.curtime);
                
                osname.setText(DSHubInitializer.Proppies.getProperty("os.name"));
                osversion.setText(DSHubInitializer.Proppies.getProperty("os.version"));
                osarch.setText(DSHubInitializer.Proppies.getProperty("os.arch"));
                jrename.setText(DSHubInitializer.Proppies.getProperty("java.version"));
                jreprovider.setText(DSHubInitializer.Proppies.getProperty("java.vendor"));
		...
		jTextArea2.setText("Death Squad Hub. Version " + Vars.HubVersion
				+ ".\n" + "  Running on "
				+ DSHubInitializer.Proppies.getProperty("os.name") + " Version "
				+ DSHubInitializer.Proppies.getProperty("os.version") + " on Architecture "
				+ DSHubInitializer.Proppies.getProperty("os.arch") + "\n"
				+ "  Java Runtime Environment "
				+ DSHubInitializer.Proppies.getProperty("java.version") + " from "
				+ DSHubInitializer.Proppies.getProperty("java.vendor") + "\n"
				+ "  Java Virtual Machine "
				+ DSHubInitializer.Proppies.getProperty("java.vm.specification.version")
	...
	private void HSTAcheckActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HSTAcheckActionPerformed
		...
		{
			DSHubInitializer.PopMsg("HSTA changed from \"0\" to \"1\".");
			Vars.HSTA = 1;
		} else {
			DSHubInitializer.PopMsg("HSTA changed from \"1\" to \"0\".");
			Vars.HSTA = 0;
		}
	...
	private void FSTAcheckActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FSTAcheckActionPerformed
		...
		{
			DSHubInitializer.PopMsg("FSTA changed from \"0\" to \"1\".");
			Vars.FSTA = 1;
		} else {
			DSHubInitializer.PopMsg("FSTA changed from \"1\" to \"0\".");
			Vars.FSTA = 0;
		}
	...
	private void ESTAcheckActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ESTAcheckActionPerformed
		...
		{
			DSHubInitializer.PopMsg("ESTA changed from \"0\" to \"1\".");
			Vars.ESTA = 1;
		} else {
			DSHubInitializer.PopMsg("ESTA changed from \"1\" to \"0\".");
			Vars.ESTA = 0;
		}
	...
	private void DSTAcheckActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DSTAcheckActionPerformed
		...
		{
			DSHubInitializer.PopMsg("DSTA changed from \"0\" to \"1\".");
			Vars.DSTA = 1;
		} else {
			DSHubInitializer.PopMsg("DSTA changed from \"1\" to \"0\".");
			Vars.DSTA = 0;
		}
	...
	private void BSTAcheckActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BSTAcheckActionPerformed
		...
		{
			DSHubInitializer.PopMsg("BSTA changed from \"0\" to \"1\".");
			Vars.BSTA = 1;
		} else {
			DSHubInitializer.PopMsg("BSTA changed from \"1\" to \"0\".");
			Vars.BSTA = 0;
		}
	...
	{//GEN-HEADEREND:event_HMSGcheckActionPerformed
		...
		{
			DSHubInitializer.PopMsg("HMSG changed from \"0\" to \"1\".");
			Vars.HMSG = 1;
		} else {
			DSHubInitializer.PopMsg("HMSG changed from \"1\" to \"0\".");
			Vars.HMSG = 0;
		}
	...
	{//GEN-HEADEREND:event_FMSGcheckActionPerformed
		...
		{
			DSHubInitializer.PopMsg("FMSG changed from \"0\" to \"1\".");
			Vars.FMSG = 1;
		} else {
			DSHubInitializer.PopMsg("FMSG changed from \"1\" to \"0\".");
			Vars.FMSG = 0;
		}
	...
	{//GEN-HEADEREND:event_EMSGcheckActionPerformed
		...
		{
			DSHubInitializer.PopMsg("EMSG changed from \"0\" to \"1\".");
			Vars.EMSG = 1;
		} else {
			DSHubInitializer.PopMsg("EMSG changed from \"1\" to \"0\".");
			Vars.EMSG = 0;
		}
	...
	{//GEN-HEADEREND:event_DMSGcheckActionPerformed
		...
		{
			DSHubInitializer.PopMsg("DMSG changed from \"0\" to \"1\".");
			Vars.DMSG = 1;
		} else {
			DSHubInitializer.PopMsg("DMSG changed from \"1\" to \"0\".");
			Vars.DMSG = 0;
		}
	...
	{//GEN-HEADEREND:event_BMSGcheckActionPerformed
		...
		{
			DSHubInitializer.PopMsg("BMSG changed from \"0\" to \"1\".");
			Vars.BMSG = 1;
		} else {
			DSHubInitializer.PopMsg("BMSG changed from \"1\" to \"0\".");
			Vars.BMSG = 0;
		}
	...
	// TODO add your handling code here:
		...
		//Main.PopMsg("clicked");
		{
			DSHubInitializer.PopMsg("Save_logs changed from \"0\" to \"1\".");
			Vars.savelogs = 1;
		} else {
			DSHubInitializer.PopMsg("Save_logs changed from \"1\" to \"0\".");
			Vars.savelogs = 0;
		}
	...
	// TODO add your handling code here:
		...
		try {
			...
			if (!(aucsy.equals(Thing))) {
				...
				DSHubInitializer.PopMsg("Opchat_name changed from \"" + aucsy + "\" to \""
						+ Thing + "\".");
		...
		if (!(aucsy.equals(Thing))) {
			...
			DSHubInitializer.PopMsg("Opchat_desc changed from \"" + aucsy + "\" to \""
					+ Thing + "\".");
			Broadcast.getInstance().broadcast(
		...
		try {
			...
			if (aucs != Integer.parseInt(Thing)) {
				...
				DSHubInitializer.PopMsg("History_lines changed from \""
		...
		try {
			...
			if (aucs != Integer.parseInt(Thing)) {
				...
				DSHubInitializer.PopMsg("Kick_time changed from \""
		...
		if (!(aucsy.equals(Thing))) {
			...
			DSHubInitializer.PopMsg("Redirect_url changed from \"" + aucsy + "\" to \""
					+ Thing + "\".");
		...
		try {
			...
			if (!(aucsy.equals(Thing))) {
				...
				Vars.bot_name = Thing;
				DSHubInitializer.PopMsg("bot_name changed from \"" + aucsy + "\" to \""
						+ Thing + "\".");
				Broadcast.getInstance().broadcast(
		...
		if (!(aucsy.equals(Thing))) {
			...
			Vars.bot_desc = Thing;
			DSHubInitializer.PopMsg("Bot_desc changed from \"" + aucsy + "\" to \"" + Thing
					+ "\".");
			Broadcast.getInstance().broadcast(
	...
	// TODO add your handling code here:
		...
		try {
			...
			if (aucsy != Integer.parseInt(Thing)) {
				...
				DSHubInitializer.PopMsg("Max_chat_msg changed from \""
		...
		try {
			...
			if (aucsy != Integer.parseInt(Thing)) {
				...
				DSHubInitializer.PopMsg("Chat_interval changed from \""
						+ Integer.toString(aucsy) + "\" to \""
						+ Vars.chat_interval + "\".");
			}
		...
		try {
			...
			if (aucsy != Integer.parseInt(Thing)) {
				...
				DSHubInitializer.PopMsg("Automagic_search changed from \""
						+ Integer.toString(aucsy) + "\" to \""
		...
		try {
			...
			if (aucsy != Integer.parseInt(Thing)) {
				...
				DSHubInitializer.PopMsg("Search_log_base changed from \""
						+ Integer.toString(aucsy) + "\" to \""
		...
		try {
			...
			if (aucsy != Integer.parseInt(Thing)) {
				...
				DSHubInitializer.PopMsg("Search_steps changed from \""
						+ Integer.toString(aucsy) + "\" to \""
						+ Vars.search_steps + "\".");
			}
		...
		try {
			...
			if (aucsy != Integer.parseInt(Thing)) {
				...
				DSHubInitializer.PopMsg("Search_spam_reset changed from \""
						+ Integer.toString(aucsy) + "\" to \""
		...
		if (!(aucsy.equals(Thing))) {
			...
			DSHubInitializer.PopMsg("Msg_Search_Spam changed from \"" + aucsy + "\" to \""
					+ Thing + "\".");
	...
	// TODO add your handling code here:
		...
		try {
			...
			if (aucsy != Integer.parseInt(Thing)) {
				...
				DSHubInitializer.PopMsg("Max_users changed from \""
		...
		if (!(aucsy.equals(Thing))) {
			...
			DSHubInitializer.PopMsg("Nick_chars changed from \"" + aucsy + "\" to \""
					+ Thing + "\".");
		}
		...
		try {
			...
			if (aucs != Integer.parseInt(Thing)) {
				...
				DSHubInitializer.PopMsg("Max_sch_chars changed from \""
						+ Integer.toString(aucs) + "\" to \""
						+ Vars.max_sch_chars + "\".");
			}
	...
	// TODO add your handling code here:
		...
		try {
			...
			if (aucsy != aux) {
				...
				DSHubInitializer.PopMsg("Timeout_Login changed from \""
		...
		try {
			...
			if (aucsy != Integer.parseInt(Thing)) {
				...
				DSHubInitializer.PopMsg("Max_ni changed from \"" + Integer.toString(aucsy)
						+ "\" to \"" + Vars.max_ni + "\".");
			}
		...
		try {
			...
			if (aucsy != Integer.parseInt(Thing)) {
				...
				DSHubInitializer.PopMsg("Min_ni changed from \"" + Integer.toString(aucsy)
						+ "\" to \"" + Vars.min_ni + "\".");
			}
		...
		try {
			...
			if (aucsy != Integer.parseInt(Thing)) {
				...
				DSHubInitializer.PopMsg("Max_de changed from \"" + Integer.toString(aucsy)
						+ "\" to \"" + Vars.max_de + "\".");
			}
		...
		try {
			...
			if (aucsy != Long.parseLong(Thing)) {
				...
				DSHubInitializer.PopMsg("Max_share changed from \"" + Long.toString(aucsy)
						+ "\" to \"" + Vars.max_share + "\".");
			}
		...
		try {
			...
			if (aucsy != Long.parseLong(Thing)) {
				...
				DSHubInitializer.PopMsg("Min_share changed from \"" + Long.toString(aucsy)
						+ "\" to \"" + Vars.min_share + "\".");
			}
		...
		try {
			...
			if (aucsy != Integer.parseInt(Thing)) {
				...
				DSHubInitializer.PopMsg("Max_sl changed from \"" + Integer.toString(aucsy)
						+ "\" to \"" + Vars.max_sl + "\".");
			}
		...
		try {
			...
			if (aucsy != Integer.parseInt(Thing)) {
				...
				DSHubInitializer.PopMsg("Min_sl changed from \"" + Integer.toString(aucsy)
						+ "\" to \"" + Vars.min_sl + "\".");
			}
		...
		try {
			...
			if (aucsy != Integer.parseInt(Thing)) {
				...
				DSHubInitializer.PopMsg("Max_em changed from \"" + Integer.toString(aucsy)
						+ "\" to \"" + Vars.max_em + "\".");
			}
		...
		try {
			...
			if (aucsy != Integer.parseInt(Thing)) {
				...
				DSHubInitializer.PopMsg("Max_hubs_op changed from \""
						+ Integer.toString(aucsy) + "\" to \""
						+ Vars.max_hubs_op + "\".");
			}
		...
		try {
			...
			if (aucsy != Integer.parseInt(Thing)) {
				...
				DSHubInitializer.PopMsg("Max_hubs_reg changed from \""
						+ Integer.toString(aucsy) + "\" to \""
						+ Vars.max_hubs_reg + "\".");
			}
		...
		try {
			...
			if (aucsy != Integer.parseInt(Thing)) {
				...
				DSHubInitializer.PopMsg("Max_hubs_user changed from \""
						+ Integer.toString(aucsy) + "\" to \""
						+ Vars.max_hubs_user + "\".");
			}
		...
		DSHubInitializer.Server.rewriteconfig();
		SetStatus("Restrictions settings saved.");
	...
	// TODO add your handling code here:
		...
		//Main.PopMsg("clicked");
		{
			DSHubInitializer.PopMsg("Reg_only changed from \"0\" to \"1\".");
			Vars.reg_only = 1;
		} else {
			DSHubInitializer.PopMsg("Reg_only changed from \"1\" to \"0\".");
			Vars.reg_only = 0;
		}
	...
	// TODO add your handling code here:
		...
		if (!(newtopic.equals(Vars.HubDE)))
			if (newtopic.equals("")) {
				...
				if (!Vars.HubDE.equals("")) {
					...
					DSHubInitializer.PopMsg("Topic was deleted by Server.");
				} else
				...
				Broadcast.getInstance().broadcast(
						"IMSG Topic was changed by Server to \"" + Vars.HubDE
								+ "\".");
				DSHubInitializer.PopMsg("Topic was changed by Server to \"" + Vars.HubDE
						+ "\".");
		...
		if (!(NowName.equals(Vars.HubName))) {
			...
			DSHubInitializer.PopMsg("Hub_Name changed from \"" + Vars.HubName + "\" to \""
					+ NowName + "\".");
	...
	private void setHost() {
		...
		if (!(new_name.equals(Vars.Hub_Host))) {
			...
			DSHubInitializer.PopMsg("Hub_host changed from \"" + Vars.Hub_Host + "\" to \""
					+ new_name + "\".");
	...
	private void SetProxy() {
		if (!proxycheck.isSelected()) {
			if (!("".equals(Vars.Proxy_Host)))
				DSHubInitializer.PopMsg("Proxy_Host changed from \"" + Vars.Proxy_Host
						+ "\" to \"" + (Vars.Proxy_Host = "") + "\".");
			if (0 != Vars.Proxy_Port)
				DSHubInitializer.PopMsg("Proxy_Port changed from \"" + Vars.Proxy_Port
	...
	public void refreshAll() {
		...
		// System.out.println (blah00);
               if(HubServer.done_adcs) 
                if(Vars.adcs_mode && DSHubInitializer.Server.adcs_ok)
                {
                ...
                {
                	if(DSHubInitializer.Server.adcs_ok)
...
*/
	...
	//clicked reg...
		DSHubInitializer.Reg(jTextField1.getText());
	...
	{//GEN-HEADEREND:event_jButton2ActionPerformed
		...
		this.dispose();
		System.gc();
		DSHubInitializer.GUIshowing = false;
	}//GEN-LAST:event_jButton2ActionPerformed

	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_jButton1ActionPerformed
	{//GEN-HEADEREND:event_jButton1ActionPerformed
		DSHubInitializer.Exit();
	...
	{//GEN-HEADEREND:event_jButton31ActionPerformed
		...
		if (!(aucsy.equals(Thing))) {
			...
			DSHubInitializer.PopMsg("Msg_Banned changed from \"" + aucsy + "\" to \""
					+ Thing + "\".");
		...
		if (!(aucsy.equals(Thing))) {
			...
			Vars.Msg_Full = Thing;
			DSHubInitializer.PopMsg("Msg_Full changed from \"" + aucsy + "\" to \"" + Thing
					+ "\".");
	...
	{//GEN-HEADEREND:event_remportActionPerformed
		...
		try {
			...
			DSHubInitializer.Server.delPort(elim);
	...
	{//GEN-HEADEREND:event_addnewportActionPerformed
		...
		try {
			...
			if (DSHubInitializer.Server.addPort(newport) == true)
	...
	{//GEN-HEADEREND:event_jButton32ActionPerformed
		DSHubInitializer.pManager.rescanScripts();
		refreshPyScripts();
	...
	{//GEN-HEADEREND:event_langcomboActionPerformed
		...
		DSHubInitializer.PopMsg("Language changed to "
...
if(command_pmcheck.isSelected())
 {
 Vars.command_pm=1;
 DSHubInitializer.PopMsg("Command_PM changed from \"0\" to \"1\"");
 }
 else
 {
  Vars.command_pm=0;
   DSHubInitializer.PopMsg("Command_PM changed from \"1\" to \"0\"");
   }
...
// TODO add your handling code here:
   int x=JOptionPane.showConfirmDialog(null,"This will remove existing keys and certificates and will generate new random keys.\n" +
    ...
    if(x==JOptionPane.OK_OPTION)
    {
        ...
        boolean keygenerated= DSHubInitializer.Server.sslmanager.getCertManager().recreateKeysCerts();
       // JOptionPane.showConfirmDialog(null,"New pair of keys and certificate were created and saved into key.crt",
        ...
        DSHubInitializer.Server.adcs_ok=true;
        if(!Vars.adcs_mode)
        getEnableadcs().setEnabled(true);
        }
        else
...
// TODO add your handling code here:
    ...
    if(x==JOptionPane.OK_OPTION)
    {
        ...
        Vars.adcs_mode=true;
        DSHubInitializer.Restart();
        DSHubInitializer.PopMsg("ADC Secure mode has been enabled");
    }
...
// TODO add your handling code here:
    ...
    if(x==JOptionPane.OK_OPTION)
    {
        ...
        DSHubInitializer.Restart();
        DSHubInitializer.PopMsg("ADC Secure mode has been disabled");
    }
...
// TODO add your handling code here:
    if (BCTMcheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("BCTM changed from \"0\" to \"1\".");
			Vars.BCTM = 1;
		} else {
			DSHubInitializer.PopMsg("BCTM changed from \"1\" to \"0\".");
			Vars.BCTM = 0;
		}
...
// TODO add your handling code here:
    if (DCTMcheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("DCTM changed from \"0\" to \"1\".");
			Vars.DCTM = 1;
		} else {
			DSHubInitializer.PopMsg("DCTM changed from \"1\" to \"0\".");
			Vars.DCTM = 0;
		}
...
// TODO add your handling code here:
    if (ECTMcheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("ECTM changed from \"0\" to \"1\".");
			Vars.ECTM = 1;
		} else {
			DSHubInitializer.PopMsg("BCTM changed from \"1\" to \"0\".");
			Vars.ECTM = 0;
...
private void FCTMcheckActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FCTMcheckActionPerformed
    ...
    if (FCTMcheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("FCTM changed from \"0\" to \"1\".");
			Vars.FCTM = 1;
		} else {
			DSHubInitializer.PopMsg("FCTM changed from \"1\" to \"0\".");
			Vars.FCTM = 0;
		}
...
// TODO add your handling code here:
    if (HCTMcheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("HCTM changed from \"0\" to \"1\".");
			Vars.HCTM = 1;
		} else {
			DSHubInitializer.PopMsg("HCTM changed from \"1\" to \"0\".");
			Vars.HCTM = 0;
		}
...
// TODO add your handling code here:
    if (BRCMcheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("BRCM changed from \"0\" to \"1\".");
			Vars.BRCM = 1;
		} else {
			DSHubInitializer.PopMsg("BRCM changed from \"1\" to \"0\".");
			Vars.BRCM = 0;
		}
...
// TODO add your handling code here:
    if (DRCMcheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("DRCM changed from \"0\" to \"1\".");
			Vars.DRCM = 1;
		} else {
			DSHubInitializer.PopMsg("DRCM changed from \"1\" to \"0\".");
			Vars.DRCM = 0;
		}
...
// TODO add your handling code here:
    if (ERCMcheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("ERCM changed from \"0\" to \"1\".");
			Vars.ERCM = 1;
		} else {
			DSHubInitializer.PopMsg("ERCM changed from \"1\" to \"0\".");
			Vars.ERCM = 0;
		}
...
// TODO add your handling code here:
    if (FRCMcheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("FRCM changed from \"0\" to \"1\".");
			Vars.FRCM = 1;
		} else {
			DSHubInitializer.PopMsg("FRCM changed from \"1\" to \"0\".");
			Vars.FRCM = 0;
		}
...
// TODO add your handling code here:
    if (HRCMcheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("HRCM changed from \"0\" to \"1\".");
			Vars.HRCM = 1;
		} else {
			DSHubInitializer.PopMsg("HRCM changed from \"1\" to \"0\".");
			Vars.HRCM = 0;
		}
...
// TODO add your handling code here:
    if (BSCHcheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("BSCH changed from \"0\" to \"1\".");
			Vars.BSCH = 1;
		} else {
			DSHubInitializer.PopMsg("BSCH changed from \"1\" to \"0\".");
			Vars.BSCH = 0;
		}
...
// TODO add your handling code here:
    if (DSCHcheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("DSCH changed from \"0\" to \"1\".");
			Vars.DSCH = 1;
		} else {
			DSHubInitializer.PopMsg("DSCH changed from \"1\" to \"0\".");
			Vars.DSCH = 0;
		}
...
// TODO add your handling code here:
    if (ESCHcheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("ESCH changed from \"0\" to \"1\".");
			Vars.ESCH = 1;
		} else {
			DSHubInitializer.PopMsg("ESCH changed from \"1\" to \"0\".");
			Vars.ESCH = 0;
		}
...
// TODO add your handling code here:
    if (FSCHcheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("FSCH changed from \"0\" to \"1\".");
			Vars.FSCH = 1;
		} else {
			DSHubInitializer.PopMsg("FSCH changed from \"1\" to \"0\".");
			Vars.FSCH = 0;
		}
...
// TODO add your handling code here:
    if (HSCHcheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("HSCH changed from \"0\" to \"1\".");
			Vars.HSCH = 1;
		} else {
			DSHubInitializer.PopMsg("HSCH changed from \"1\" to \"0\".");
			Vars.HSCH = 0;
		}
...
// TODO add your handling code here:
    if (BREScheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("BRES changed from \"0\" to \"1\".");
			Vars.BRES = 1;
		} else {
			DSHubInitializer.PopMsg("BRES changed from \"1\" to \"0\".");
			Vars.BRES = 0;
		}
...
// TODO add your handling code here:
    if (DREScheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("DRES changed from \"0\" to \"1\".");
			Vars.DRES = 1;
		} else {
			DSHubInitializer.PopMsg("DRES changed from \"1\" to \"0\".");
			Vars.DRES = 0;
		}
...
// TODO add your handling code here:
    if (EREScheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("ERES changed from \"0\" to \"1\".");
			Vars.ERES = 1;
		} else {
			DSHubInitializer.PopMsg("ERES changed from \"1\" to \"0\".");
			Vars.ERES = 0;
		}
...
// TODO add your handling code here:
    if (FREScheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("FRES changed from \"0\" to \"1\".");
			Vars.FRES = 1;
		} else {
			DSHubInitializer.PopMsg("FRES changed from \"1\" to \"0\".");
			Vars.FRES = 0;
		}
...
// TODO add your handling code here:
    if (HREScheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("HRES changed from \"0\" to \"1\".");
			Vars.HRES = 1;
		} else {
			DSHubInitializer.PopMsg("HRES changed from \"1\" to \"0\".");
			Vars.HRES = 0;
		}
...
// TODO add your handling code here:
    if (BPAScheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("BPAS changed from \"0\" to \"1\".");
			Vars.BPAS = 1;
		} else {
			DSHubInitializer.PopMsg("BPAS changed from \"1\" to \"0\".");
			Vars.BPAS = 0;
		}
...
// TODO add your handling code here:
     ...
     if (DPAScheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("DPAS changed from \"0\" to \"1\".");
			Vars.DPAS = 1;
		} else {
			DSHubInitializer.PopMsg("DPAS changed from \"1\" to \"0\".");
			Vars.DPAS = 0;
		}
...
// TODO add your handling code here:
     if (EPAScheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("EPAS changed from \"0\" to \"1\".");
			Vars.EPAS = 1;
		} else {
			DSHubInitializer.PopMsg("EPAS changed from \"1\" to \"0\".");
			Vars.EPAS = 0;
		}
...
// TODO add your handling code here:
     ...
     if (FPAScheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("FPAS changed from \"0\" to \"1\".");
			Vars.FPAS = 1;
		} else {
			DSHubInitializer.PopMsg("FPAS changed from \"1\" to \"0\".");
			Vars.FPAS = 0;
		}
...
// TODO add your handling code here:
     if (HPAScheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("HPAS changed from \"0\" to \"1\".");
			Vars.HPAS = 1;
		} else {
			DSHubInitializer.PopMsg("HPAS changed from \"1\" to \"0\".");
			Vars.HPAS = 0;
		}
...
// TODO add your handling code here:
     if (BSUPcheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("BSUP changed from \"0\" to \"1\".");
			Vars.BSUP = 1;
		} else {
			DSHubInitializer.PopMsg("BSUP changed from \"1\" to \"0\".");
			Vars.BSUP = 0;
		}
...
private void DSUPcheckActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DSUPcheckActionPerformed
 if (DSUPcheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("DSUP changed from \"0\" to \"1\".");
			Vars.DSUP = 1;
		} else {
			DSHubInitializer.PopMsg("DSUP changed from \"1\" to \"0\".");
			Vars.DSUP = 0;
		}
...
// TODO add your handling code here:
     ...
     if (ESUPcheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("ESUP changed from \"0\" to \"1\".");
			Vars.ESUP = 1;
		} else {
			DSHubInitializer.PopMsg("ESUP changed from \"1\" to \"0\".");
			Vars.ESUP = 0;
		}
...
// TODO add your handling code here:
     if (FSUPcheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("FSUP changed from \"0\" to \"1\".");
			Vars.FSUP = 1;
		} else {
			DSHubInitializer.PopMsg("FSUP changed from \"1\" to \"0\".");
			Vars.FSUP = 0;
		}
...
// TODO add your handling code here:
     ...
     if (HSUPcheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("HSUP changed from \"0\" to \"1\".");
			Vars.HSUP = 1;
		} else {
			DSHubInitializer.PopMsg("HSUP changed from \"1\" to \"0\".");
			Vars.HSUP = 0;
		}
...
// TODO add your handling code here:
    if (BINFcheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("BINF changed from \"0\" to \"1\".");
			Vars.BINF = 1;
		} else {
			DSHubInitializer.PopMsg("BINF changed from \"1\" to \"0\".");
			Vars.BINF = 0;
		}
...
// TODO add your handling code here:
    if (DINFcheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("DINF changed from \"0\" to \"1\".");
			Vars.DINF = 1;
		} else {
			DSHubInitializer.PopMsg("DINF changed from \"1\" to \"0\".");
			Vars.DINF = 0;
		}
...
// TODO add your handling code here:
    if (EINFcheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("EINF changed from \"0\" to \"1\".");
			Vars.EINF = 1;
		} else {
			DSHubInitializer.PopMsg("EINF changed from \"1\" to \"0\".");
			Vars.EINF = 0;
		}
...
// TODO add your handling code here:
    if (FINFcheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("FINF changed from \"0\" to \"1\".");
			Vars.FINF = 1;
		} else {
			DSHubInitializer.PopMsg("FINF changed from \"1\" to \"0\".");
			Vars.FINF = 0;
		}
...
// TODO add your handling code here:
    if (HINFcheck.isSelected())
		...
		{
			DSHubInitializer.PopMsg("HINF changed from \"0\" to \"1\".");
			Vars.HINF = 1;
		} else {
			DSHubInitializer.PopMsg("HINF changed from \"1\" to \"0\".");
			Vars.HINF = 0;
		}
	...
	public void SetStatus(String newstring, int msgType) {
		...
		if (DSHubInitializer.GUIshowing)
