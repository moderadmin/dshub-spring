...
public class ChatControlCmd
{
    ...
    " Replace matching word with stars ( **** ) 16\n"+" Modify matching word with given modification 32\n"+" Control private chat as well 64\n"+
        ...
        if ( what.equalsIgnoreCase("list"))
        {
            String Help="\nChat Control List:"
                    ...
                    ;
            Help+= DSHubInitializer.listaBanate.List();
    ...
    public static final long searches=256;*/
                ...
                case 20+128+64:
                    ...
                    DSHubInitializer.listaBanate.add(regex,(long)flag,"x");
                ...
                case 36+128+64+256:
                {
                    ...
                    DSHubInitializer.listaBanate.add(regex,(long)flag,repl);
                     cur_client.sendFromBot("Successfully added.");
                    break;
                }
                default:
            ...
            DSHubInitializer.GUI.refreshListaBanate();
        ...
        else if(what.equalsIgnoreCase("mod"))
        {
            ...
            if(DSHubInitializer.listaBanate.size()<id)
            {
    ...
    static final long allword=56;*/
                ...
                case 20+128+64:
                if(id!=-1)
                    DSHubInitializer.listaBanate.modifyPrAt(id,(long)flag,"x");
                else
                     if(DSHubInitializer.listaBanate.modifyPr(regex,(long)flag,"x")==false)
                     {
                ...
                case 36+128+64+256:
                {
                    ...
                    repl=repl.substring(0,repl.length()-1);
                    if(id!=-1)
                    DSHubInitializer.listaBanate.modifyPrAt(id,(long)flag,repl);
                else
                     DSHubInitializer.listaBanate.modifyPr(regex,(long)flag,repl);
                     cur_client.sendFromBot("Successfully modified.");
                    break;
                }
                default:
        ...
        else if(what.equalsIgnoreCase("del"))
        {
            ...
            if(id!=-1)
                    DSHubInitializer.listaBanate.removeElAt(id);
                else
                     if(DSHubInitializer.listaBanate.removeElement(regex)==false)
                     {
                          cur_client.sendFromBot("Regular expression doesn't exist.");
                          return;
                     }
        ...
        else if(what.equalsIgnoreCase("save"))
        {
            ...
            path=path.substring(1,path.length()-1);
             ...
             if(DSHubInitializer.listaBanate.printFile(path)==true)
        ...
        else if(what.equalsIgnoreCase("load"))
        {
            ...
            path=path.substring(1,path.length()-1);
             ...
             if(DSHubInitializer.listaBanate.loadFile(path)==true)
