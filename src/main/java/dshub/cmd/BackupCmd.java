...
public class BackupCmd
{
    ...
    public BackupCmd(ClientHandler cur_client,String cmd)
    {
        ...
        if(what.equalsIgnoreCase("all"))
        {
           ...
           if( DSHubInitializer.Server.rewriteconfig("config.bak")==false)
               toSend+="Error while writing configuration. ";
            else
                toSend+="Configuration saved [config.bak]. ";;
            if(DSHubInitializer.Server.rewriteregs("regs.bak")==false)
                toSend+="Error while writing regs. ";
            else
                toSend+="Regs saved [regs.bak].";;
             if(DSHubInitializer.Server.rewritebans("bans.bak")==false)
        ...
        else if(what.equalsIgnoreCase("bans"))
        {
            ...
            if(DSHubInitializer.Server.rewritebans(name)==true)
         ...
         else if(what.equalsIgnoreCase("regs"))
        {
            ...
            if(DSHubInitializer.Server.rewriteregs(name)==true)
         ...
         else if(what.equalsIgnoreCase("config"))
        {
           ...
           if( DSHubInitializer.Server.rewriteconfig(name)==true)
