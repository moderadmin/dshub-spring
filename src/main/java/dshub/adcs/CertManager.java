...
public class CertManager
{
    ...
    public boolean storeCerts()
    {
           ...
           KeyStore store=genKeyStore();
			...
			try {
				fOut = new FileOutputStream(DSHubInitializer.myPath+"key.crt");
    ...
    public KeyStore loadKeyStore() 
    {
    	...
    	java.io.FileInputStream fis = null;
    	    try {
    	         fis = new java.io.FileInputStream(DSHubInitializer.myPath+"key.crt");
    ...
    public KeyStore genKeyStore()
    {
		...
		try {
			...
			// TODO Auto-generated catch block
			e.printStackTrace();
			DSHubInitializer.PopMsg(e.getMessage());
		}
    ...
    public boolean recreateKeysCerts()
    {
        ...
        try {
        	DSHubInitializer.PopMsg("Creating hub certificate...");
