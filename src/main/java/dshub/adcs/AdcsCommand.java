        ...
        if(what.equalsIgnoreCase("regen"))
        {
        	cur_client.sendFromBot("Regenerating keys and certificate... ( this may take a while )");
              ...
              // JOptionPane.showConfirmDialog(null,"New pair of keys and certificate were created and saved into key.crt",
               ...
               if(keygenerated)
               {
               DSHubInitializer.PopMsg("New pair of keys and certificate were created and saved into key.crt");
               ...
               if(!Vars.adcs_mode)
               DSHubInitializer.GUI.getEnableadcs().setEnabled(true);
               }
               else
               	{
            	   DSHubInitializer.PopMsg("Error creating keys and certificates. Check the log for details.");
