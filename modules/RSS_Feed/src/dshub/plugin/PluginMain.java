 ...
 /** Called by hub main threads when a client sends any raw command;
    ...
    public boolean startup()
    {
        ...
        try
        {
            ...
            File RSSFile = new File(DSHubInitializer.myPath+"rss"); //making a new File thingy that access the "rss" file
    ...
    public static void writeRSSAddress()
    {
        try
        {
           ...
           FileWriter fstream = new FileWriter(DSHubInitializer.myPath+"rss");
